...
<div id="left_home">
  <img style="float:left;" src="<? bloginfo('template_directory'); ?>/images/pic1.jpg" />
  <img style="float:right;" src="<? bloginfo('template_directory'); ?>/images/pic3.jpg" />
  <img src="<? bloginfo('template_directory'); ?>/images/pic2.jpg" />
</div>

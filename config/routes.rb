ActionController::Routing::Routes.draw do |map|
  map.namespace :admin do |admin|
    ...
    admin.resources :address_lists, :articles, :blogs, :composite_pages, :documents, :donation_pages, :galleries, :homes, :newsletters, :pages, :photos, :posts, :sections, :two_column_pages
